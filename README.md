...
3. **K3 Change:** Write files to feature branch.
...
5. **Set-restricted integral ambiguity:** When Lean reports *"expected ';'
   or line break"* near an integral expression, the cause is almost always
